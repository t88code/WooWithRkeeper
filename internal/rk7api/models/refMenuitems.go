...
type MenuitemItem struct {
	...
	WOO_IMAGE_NAME_1    string `xml:"genWOO_IMAGE_NAME_1,attr"`
	WOO_IMAGE_NAME_2    string `xml:"genWOO_IMAGE_NAME_2,attr"`
	WOO_IMAGE_NAME_3    string `xml:"genWOO_IMAGE_NAME_3,attr"`
	WOO_IMAGE_NAME_4    string `xml:"genWOO_IMAGE_NAME_4,attr"`
	WOO_IMAGE_NAME_5    string `xml:"genWOO_IMAGE_NAME_5,attr"`
	WOO_IMAGE_NAME_6    string `xml:"genWOO_IMAGE_NAME_6,attr"`
	WOO_IMAGE_NAME_7    string `xml:"genWOO_IMAGE_NAME_7,attr"`
	WOO_IMAGE_NAME_8    string `xml:"genWOO_IMAGE_NAME_8,attr"`
	WOO_IMAGE_NAME_9    string `xml:"genWOO_IMAGE_NAME_9,attr"`
	WOO_IMAGE_NAME_10   string `xml:"genWOO_IMAGE_NAME_10,attr"`
...
func (m *MenuitemItem) ImageNamesExistLen() (len int) {
	imageNamesString := m.GetImageNames()
	for _, imageName := range imageNamesString {
		if imageName != "" {
			len++
		}
	}
