...
//		logger.Debug("--------------------------------------")
//		imageNames := [10]string{
//			menuitem.WOO_IMAGE_NAME_1,
//			menuitem.WOO_IMAGE_NAME_2,
//			menuitem.WOO_IMAGE_NAME_3,
//			menuitem.WOO_IMAGE_NAME_4,
//			menuitem.WOO_IMAGE_NAME_5,
//			menuitem.WOO_IMAGE_NAME_6,
//			menuitem.WOO_IMAGE_NAME_7,
//			menuitem.WOO_IMAGE_NAME_8,
//			menuitem.WOO_IMAGE_NAME_9,
//			menuitem.WOO_IMAGE_NAME_10,
//		}
...
//					String: database.IMAGE_STATUS_IGNORE,
//					Valid:  true,
//				}
...
//			menuitemsNotActive++
//		} else {
//			logger.Debug("Блюдо активное. Проверяем цену/стоп-лист/включ синк")
//			menuitemsActive++
...
//				logger.Debug("Блюдо - цена не указана/стоп-лист/выключенная синхронизация. Пропускаем.")
//				imageRowDb.Status = sql.NullString{
//					String: database.IMAGE_STATUS_IGNORE,
//					Valid:  true,
//				}
...
//						imageRowDb.Status = sql.NullString{
//							String: database.IMAGE_STATUS_RK7_IMAGE_NAME_NOT_FOUND,
//							Valid:  true,
//						}
//						err := imageRowDb.UpdateInDb(db)
//						if err != nil {
...
//						imageRowDb.Status = sql.NullString{
//							String: database.IMAGE_STATUS_IN_WOO_NOT_FOUND,
//							Valid:  true,
//						}
//						err := imageRowDb.UpdateInDb(db)
//						if err != nil {
...
//						imageRowDb.Status = sql.NullString{
//							String: database.IMAGE_STATUS_RK7_WOO_ID_NOT_FOUND,
//							Valid:  true,
//						}
//						err := imageRowDb.UpdateInDb(db)
//						if err != nil {
